...
class Config:
    ...
    # WORK_ALLOCATE_URL = "http://61.84.75.37:3302/api/work/allocate-screenshot?type=adjust&site_code=topr"  # 테스트 모드
    ...
    ENABLE_FINGERPRINT_CHECK = False  # Fingerprint.com playground 접속 및 visitorId 추출 여부 (--adjust 옵션으로 활성화)
