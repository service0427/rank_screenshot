...
echo ""
echo "  1️⃣  멀티 워커 실행 (권장, 핑거프린트 프리셋 포함):"
echo "     ${GREEN}python3 uc_run_workers.py -t 6 --fingerprint-preset full${NC}"
echo ""
echo "  2️⃣  단일 Agent 테스트 (핑거프린트 프리셋 포함):"
echo "     ${GREEN}python3 uc_agent.py --version 130 --keyword \"노트북\" --fingerprint-preset full --close${NC}"
echo ""
